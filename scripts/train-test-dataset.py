...
#Creating test and train dataset from the maccrobat dataset
#Entities in test dataset are shuffled and randomly selected (min 1, max 5)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default=None) #--> path to dataset directory
    parser.add_argument("--train_save", type=str, default=None) #--> path to saving training dataset (name it too)
    parser.add_argument("--test_save", type=str, default=None) #--> path to saving test dataset (name it too)
